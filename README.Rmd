...
1. Loading the data (`screenMental`) set integrated in the package and preparing training and prediction data sets  
...
We first generate a data set with simulated sex and age values and visualize and the underlying distribution estimates:

```{r, fig.width=7, fig.height=5, fig.cap="Fig. 4 Estimated age distributions by sex"}
