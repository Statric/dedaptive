...
1. Loading the data set (`screenMental`) integrated into the package  
...
To illustrate the predictions we chose a 30 years old woman with a PHQ-9 sum score of 6 and a GAD-7 sum score of 3. 
